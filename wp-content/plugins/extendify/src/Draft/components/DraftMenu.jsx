	...
	return (
		<MenuGroup>
			<MenuItem
				disabled={disabled}
				onClick={() =>
					handleClick(__('Write a blog post about', 'extendify') + ' ')
				}
				className="group">
				<Icon
					icon={pencil}
			...
			<MenuItem
				disabled={disabled}
				onClick={() => handleClick(__('Write a poem about', 'extendify') + ' ')}
				className="group">
				<Icon
					icon={pencil}
					className="shrink-0 group-hover:text-current text-design-main fill-current w-5 h-5 mr-2"
			...
			<MenuItem
				disabled={disabled}
				onClick={() =>
					handleClick(__('Write a press release for', 'extendify') + ' ')
				}
				className="group">
				<Icon
					icon={pencil}
			...
			<MenuItem
				disabled={disabled}
				onClick={() =>
					handleClick(__('Write a pros and cons list for', 'extendify') + ' ')
				}
				className="group">
				<Icon
					icon={pencil}
			...
			<MenuItem
				disabled={disabled}
				onClick={() =>
					handleClick(__('Write a job description for', 'extendify') + ' ')
				}
				className="group">
				<Icon
					icon={pencil}
