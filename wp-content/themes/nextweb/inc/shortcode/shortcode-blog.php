...
class sh_blog_shortcode {
	...
	function sh_blog_style_3 ( $the_query, $atts ) {
		...
		$html = '';
		$html .= '<div class="slick-carousel list-products" 
	        	data-item="3" 
	        	data-item_md="3" 
	        	data-item_sm="2" 
	        	data-item_mb="1" 
	 ...
	 *
	 */
	function sh_general_post_html ( $post_class = array(), $atts = array(), $image_size = 'sh_thumb600x400' ) {
		extract( shortcode_atts( array(
			'posts_per_page'				=> '5',
			'categories'					=> '',
			'viewmore_text'					=> __( 'Read more', 'shtheme' ),
		...
		$html .= '<div class="entry-content">';
			if ( $hide_meta == '1' ) {
				$html .= '<div class="entry-meta">';
					$html .= '<span class="date-time">'. get_the_time('d-m-Y') .'</span>';
				$html .= '</div>';
			}
			...
			if ( $btn_viewmore == '1' ) {
				$html .= '<a href="'. get_permalink() .'" title="'. get_the_title() .'" class="view-more">'. $viewmore_text .' </a>';
			}
		$html .= '</div>';
		$html .= '</div></article>';
		return $html;
	 ...
	 *
	 */
	function sh_general_post_html_style_2 ( $post_class = array(), $atts = array(), $image_size = 'sh_thumb600x400' ) {
		extract( shortcode_atts( array(
			'posts_per_page'				=> '5',
			'categories'					=> '',
			'viewmore_text'					=> __( 'Read more', 'shtheme' ),
		...
		// Metadata
			...
			// Check display view more button
			if ( $btn_viewmore == '1' ) {
				$html .= '<div class="text-left"><a class="view-detail" href="'. get_permalink() .'" title="'. get_the_title() .'">'. $viewmore_text .' </a></div>';
			}
		$html .= '</div>';
		$html .= '</div></article>';
		return $html;
