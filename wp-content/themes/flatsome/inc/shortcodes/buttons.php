...
function facebook_login_shortcode( $atts, $content = null ) {
	...
	?>
	<a rel="nofollow" href="<?php echo esc_url( $facebook_url ); ?>" class="button <?php echo esc_attr( $size ); ?> facebook-button" data-plugin="nsl" data-action="connect" data-redirect="current" data-provider="facebook" data-popupwidth="475" data-popupheight="175">
