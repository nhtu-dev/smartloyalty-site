            ...
            <div class="flex-row align-top">
                ...
                <div class="flex-col flex-grow">
                 ...
                 <div class="comment-meta commentmetadata uppercase is-xsmall clear">
                    <a rel="nofollow" href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>"><time datetime="<?php comment_time( 'c' ); ?>" class="pull-left">
...
function flatsome_posted_on() {
    ...
    $posted_on = sprintf(
        ...
        '<a rel="nofollow" rel="bookmark">' . $time_string . '</a>'
    );

    $byline = sprintf(
        esc_html_x( 'by %s', 'post author', 'flatsome' ),
        '<span class="meta-author vcard"><a rel="nofollow" class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
    );
